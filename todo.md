...
CREATE TABLE public.comment_dislikes (
  ...
  CONSTRAINT comment_dislikes_comment_id_fkey FOREIGN KEY (comment_id) REFERENCES public.post_comments(id),
  CONSTRAINT comment_dislikes_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.post_dislikes (
  ...
  user_id uuid NOT NULL,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT post_dislikes_pkey PRIMARY KEY (post_id, user_id),
