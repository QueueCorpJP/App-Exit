      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose max-w-none">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第10条（Cookieの使用について）</h2>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第11条（お問い合わせ窓口）</h2>
            <p className="text-gray-700 mb-4">
