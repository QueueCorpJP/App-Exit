      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose max-w-none">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第7条（プロジェクトの審査・承認）</h2>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第9条（利用制限および登録抹消）</h2>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第10条（抜けがけ・直接取引の禁止）</h2>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第12条（保証の否認および免責事項）</h2>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第13条（サービス内容の変更等）</h2>
            <p className="text-gray-700 mb-4">
              当社は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第14条（利用規約の変更）</h2>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第15条（個人情報の取扱い）</h2>
            <p className="text-gray-700 mb-4">
              当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第16条（通知または連絡）</h2>
            <p className="text-gray-700 mb-4">
              ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第17条（権利義務の譲渡の禁止）</h2>
            <p className="text-gray-700 mb-4">
              ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">第18条（準拠法・裁判管轄）</h2>
            <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
