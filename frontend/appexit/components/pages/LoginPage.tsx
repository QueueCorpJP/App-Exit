  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        console.log('[LOGIN] Session created! Token:', data.session.access_token.substring(0, 50));
        // セッションはSupabaseとauth-contextが自動的に管理
        // onAuthStateChangeが発火してauth-contextが更新される
        router.push('/');
      } else {
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-slate-50"
              >
